...
:MIGHTYENITE => {
	:ID => 711,
	:name => "Mightyenite",
	:desc => "Have Mightyena hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:KELDEONITE => {
	:ID => 719,
	:name => "Keldeonite",
	:desc => "Have Keldeo hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:KYUREMNITEB => {
	:ID => 771,
	:name => "Kyuremnite B",
	:desc => "Have Kyurem hold it, and this stone will enable it to Mega Evolve during battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,

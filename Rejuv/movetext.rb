...
:STEAMROLLER => {
	...
	:target => :SingleNonUser,
	:contact => true,
	:desc => "The user crushes its targets by rolling over them with its rolled-up body."
},
...
:SILVERWIND => {
	...
	:highcrit => true,
	:sharpmove => true,
	:desc => "The target is hit with powdery sharp scales blown by wind this attack lands critical hits more frequently."
},
...
:NIGHTDAZE => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The user lets loose a black shock wave. It also lowers the own Special Attack."
},
...
:DRAGONRUSH => {
	...
	:contact => true,
	:kingrock => true,
	:desc => "The user tackles the target while exhibiting menace."
},
...
:DRAGONBREATH => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The user exhales a mighty gust that inflicts serious damage."
},
...
:DYNAMICPUNCH => {
	...
	:contact => true,
	:punchmove => true,
	:desc => "The user punches the target with full power."
},
...
:AIRCUTTER => {
	...
	:highcrit => true,
	:sharpmove => true,
	:desc => "Razor-like tensioned wind is launched to slash the opposing team. Critical hits land more easily."
},
...
:OMINOUSWIND => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The user blasts the target with a strong heavy gust of repulsive wind."
},
...
:THRASH => {
	...
	:kingrock => true,
	:recoil => 0.25,
	:desc => "The user attacks recklessly. It then causes recoil."
},
...
:EGGBOMB => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "Three large eggs are hurled at the target three times growing with each hit to inflict damage."
},
...
:UPROAR => {
	...
	:kingrock => true,
	:soundmove => true,
	:desc => "The user unleashes a super sonic fast noisy wave to deal damage."
},
...
:COMETPUNCH => {
	...
	:kingrock => true,
	:punchmove => true,
	:desc => "The user throws three steely punches driven by ironed will getting stronger with each hit."
},
...
:FRUSTRATION => {
	...
	:contact => true,
	:kingrock => true,
	:desc => "The power of friendship amplifies this attack the user yeets on the enemy while being cloaked in energy."
},
...
:ANCIENTPOWER => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The user attacks with a force of strong prehistoric power."
},
...
:LEAFAGE => {
	...
	:kingrock => true,
	:sharpmove => true,
	:desc => "The user attacks by pelting the target with millions of sharp leaves."
},
...
:INFERNALPARADE => {
	...
	:target => :SingleNonUser,
  	:kingrock => true,
	:punchmove => true,
  	:desc => "The user rampages around aiming and punching the enemy with flames. This also may burn the target."
},
...
:RAGINGFURY => {
	...
	:punchmove => true,
	:recoil => 0.15,
  	:desc => "The user rampages around aiming and punching the enemy with flames a little amount of recoil is caused."
},
...
:FEVERPITCH => {
	...
	:kingrock => true,
	:soundmove => true,
	:desc => "The user emits a rocking hot sound."
},
...
:GILDEDARROW => {
	...
	:highcrit => true,
	:sharpmove => true,
	:desc => "The user fires a powerful sharp golden arrow of energy at the target. critical hits land more easily."
},
